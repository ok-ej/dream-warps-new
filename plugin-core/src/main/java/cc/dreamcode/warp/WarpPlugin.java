...
import cc.dreamcode.warp.command.WarpCommand;
import cc.dreamcode.warp.command.handler.InvalidInputHandlerImpl;
import cc.dreamcode.warp.command.handler.InvalidPermissionHandlerImpl;
import cc.dreamcode.warp.command.handler.InvalidSenderHandlerImpl;
import cc.dreamcode.warp.command.handler.InvalidUsageHandlerImpl;
import cc.dreamcode.warp.command.result.BukkitNoticeResolver;
import cc.dreamcode.warp.config.MessageConfig;
import cc.dreamcode.warp.config.PluginConfig;
import cc.dreamcode.warp.nms.api.VersionProvider;
import cc.dreamcode.warp.warp.WarpRepository;
...
public final class WarpPlugin extends DreamBukkitPlatform implements DreamBukkitConfig, DreamPersistence {

    @Getter private static WarpPlugin instance;
    ...
    public void enable(@NonNull ComponentService componentService) {
        ...
        componentService.registerComponent(WarpRepository.class);
        componentService.registerComponent(WarpService.class);
        componentService.registerComponent(WarpCommand.class);
    }
    ...
    public @NonNull DreamVersion getDreamVersion() {
        return DreamVersion.create("Dream-Warp", "1.0-InDEV", "author");
    }
